...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
           ...
           <?php //SumitGohil ?>
           <?php do_action( 'woocommerce_cart_totals_before_order_total_gsttax' ); ?>
            <tr><td style="text-align: left !important;">GST</td><td><?php wc_cart_totals_order_total_html_gsttax(); ?></td></tr>
...
<br clear="all" />
	...
	</div><div class="wc-continue wc-proceed-to-checkout"><a class="wc-continuealt wc-forward" href="<?php echo get_site_url(); ?>"><?php _e( 'Continue Shopping', 'woocommerce' ) ?></a></div>